  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row bg-green-900 rounded-3xl m-4 md:h-[700px] items-center">
        <div className="flex flex-col p-8 md:w-1/2 text-center md:text-left animate-fadeIn">
          <h1 className="text-white text-xl md:text-2xl">Waste to Wonder!</h1>
          <h2 className="text-white text-4xl md:text-7xl font-semibold mt-4 capitalize animate-fadeIn">
        ...
        <div className="p-8 md:w-1/2 hidden md:block animate-fadeIn">
          <AnimatedImages />
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8 p-4 md:p-8">
        <div className="rounded-2xl border-gray-300 border p-6 md:w-1/3 animate-fadeIn">

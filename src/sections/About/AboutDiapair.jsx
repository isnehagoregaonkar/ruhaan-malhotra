      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-center">
        ...
        <div className="flex flex-col gap-4 order-2 md:order-1">
          ...
          <div className="space-y-4">
            <GrayText>
              Diapair is a student-to-alumni platform I created to build a more
              interconnected community within my school. Its mission is to
              bridge the gap between current high school students and alumni by
              connecting them through shared interests. The platform facilitates
              networking and mentorship opportunities, helping students gain
              insights from those who have previously navigated their paths. We
              host panels and discussions across schools and universities,
              engaging over 1,000 registered students. Diapair empowers students
              with valuable guidance and fosters a supportive community that
